...
@ToString
@EqualsAndHashCode
public class GreaterEqualAttributeFilter<T> implements AttributeFilter<T> {

	private static final Logger logger = LoggerFactory.getLogger(GreaterEqualAttributeFilter.class);

	private AttributeFilter<T> delegate;
	
	public GreaterEqualAttributeFilter(String name, String value, AttributeAccessor<T> accessor) {
	...
	@EqualsAndHashCode(callSuper = true)
	private static class NumericFilter<T> extends AbstractGreaterEqualAttributeFilter<T, BigDecimal> {
	...
	@EqualsAndHashCode(callSuper = true)
	private static class LocalDateFilter<T> extends AbstractGreaterEqualAttributeFilter<T, LocalDate> {
	...
	@EqualsAndHashCode(callSuper = true)
	private static class LocalTimeFilter<T> extends AbstractGreaterEqualAttributeFilter<T, LocalTime> {
	...
	@EqualsAndHashCode(callSuper = true)
	private static class LocalDateTimeFilter<T> extends AbstractGreaterEqualAttributeFilter<T, LocalDateTime> {
	...
	@EqualsAndHashCode(callSuper = true)
	private static class OffsetDateTimeFilter<T> extends AbstractGreaterEqualAttributeFilter<T, OffsetDateTime> {
	...
	@EqualsAndHashCode(callSuper = true)
	private static class ZonedDateTimeFilter<T> extends AbstractGreaterEqualAttributeFilter<T, ZonedDateTime> {
