...
@ToString
@EqualsAndHashCode
public class LesserEqualAttributeFilter<T> implements AttributeFilter<T> {

	private static final Logger logger = LoggerFactory.getLogger(LesserEqualAttributeFilter.class);

	private AttributeFilter<T> delegate;

	public LesserEqualAttributeFilter(String name, String value, AttributeAccessor<T> accessor) {
	...
	@EqualsAndHashCode(callSuper = true)
	private static class NumericFilter<T> extends AbstractLesserEqualAttributeFilter<T, BigDecimal> {
	...
	@EqualsAndHashCode(callSuper = true)
	private static class LocalDateFilter<T> extends AbstractLesserEqualAttributeFilter<T, LocalDate> {
	...
	@EqualsAndHashCode(callSuper = true)
	private static class LocalTimeFilter<T> extends AbstractLesserEqualAttributeFilter<T, LocalTime> {
	...
	@EqualsAndHashCode(callSuper = true)
	private static class LocalDateTimeFilter<T> extends AbstractLesserEqualAttributeFilter<T, LocalDateTime> {
	...
	@EqualsAndHashCode(callSuper = true)
	private static class OffsetDateTimeFilter<T> extends AbstractLesserEqualAttributeFilter<T, OffsetDateTime> {
	...
	@EqualsAndHashCode(callSuper = true)
	private static class ZonedDateTimeFilter<T> extends AbstractLesserEqualAttributeFilter<T, ZonedDateTime> {
