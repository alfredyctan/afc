...
public class GreaterAttributeFilterTest {

	@Rule
	public TestName name = new TestName();
	
	private GreaterAttributeFilter<Map<String, String>> filter;
	...
	public void testString() throws Exception {
		filter = new GreaterAttributeFilter<>("STATUS", "FULL", new MockAttributeAccessor());
	...
	public void testNumeric() throws Exception {
		filter = new GreaterAttributeFilter<>("AMOUNT", "700000", new MockAttributeAccessor());
	...
	public void testLocalDate() throws Exception {
		filter = new GreaterAttributeFilter<>("LOCALDATE", "2018-06-20", new MockAttributeAccessor());
	...
	public void testLocalTime() throws Exception {
		filter = new GreaterAttributeFilter<>("LOCALTIME", "09:15:30", new MockAttributeAccessor());
	...
	public void testLocalDateTime() throws Exception {
		filter = new GreaterAttributeFilter<>("LOCALDATETIME", "2018-06-20T09:15:30", new MockAttributeAccessor());
	...
	public void testOffsetDateTimer() throws Exception {
		filter = new GreaterAttributeFilter<>("OFFSETDATETIME", "2018-06-20T09:15:30+08:00", new MockAttributeAccessor());
	...
	public void testZonedDateTime() throws Exception {
		filter = new GreaterAttributeFilter<>("ZONEDDATETIME", "2018-06-20T09:15:30+08:00[Asia/Hong_Kong]", new MockAttributeAccessor());
	...
	public void testAttributeNotFound() throws Exception {
		filter = new GreaterAttributeFilter<>("notexist", "?", new MockAttributeAccessor());
	...
	public void testDateTypeMismatch() throws Exception {
		filter = new GreaterAttributeFilter<>("AMOUNT", "2018-06-20", new MockAttributeAccessor());
	...
	public void testNumericTypeMismatch() throws Exception {
		filter = new GreaterAttributeFilter<>("DATE", "700000", new MockAttributeAccessor());
